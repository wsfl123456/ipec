...
export default class IpArt extends React.Component<IIpArtProps, IIpArtState> {
  ...
  async _clickTab(item: any) {
    ...
    if (item.id === 2) {
      ...
      if (userGuid !== null && memberLevel > 1) {
  ...
  render() {
    ...
    const {
      ...
      businessData, indicator, boxOfficeData, boxOfficeDate, broadcastNO, ipTotalData,
                    ...
                    <li key={k}>
                      <Link to="/ip-list" onClick={async () => {
                        ...
                        await ip_list.ipTypeNav(ipDetailData.mainTypeName, {
                          ...
                          ipType: KVnumber[ipDetailData.ipTypeSuperiorNumber]
                        });

                        await ip_list.otherViewSetselected({
                          nav: KVnumber[ipDetailData.ipTypeSuperiorNumber],
        ...
        <div className="tab-container">
          ...
          <div className="tab-content" style={{ "display": isShow2 }}>
            <div className="module-box">
              ...
              {
                !_isEmpty(userData) && !_isEmpty(ipTotalData) && (memberLevel > 0 || realStatus === 1) &&
                <div className="area-content">
              ...
              {!_isEmpty(userData) && realStatus !== 1 && memberLevel < 1 &&
              <div className="area-content fans-content "><Certification/></div>}
            </div>
              ...
              <div className="module-box">
                ...
                <div className="area-content hot-content" style={{ padding: '0.3rem 0.2rem' }}>
                  <div className="date-select">
                    {
                      !_isEmpty(userData) && !_isEmpty(userData.userGuid) && (realStatus === 1 || memberLevel > 0)
                  ...
                  {!_isEmpty(userData) && !_isEmpty(boxOfficeData) && realStatus !== 1 && memberLevel < 1 &&
                  <Certification/>}
                  {!_isEmpty(userData) && _isEmpty(boxOfficeData) && (realStatus === 1 || memberLevel > 0) &&
                  <NoResult/>}
                </div>
              </div>
            }
            {
              ...
              <div className="module-box">
                ...
                <div className="area-content hot-content">
                  ...
                  <div className="date-select">
                    {
                      !_isEmpty(userData) && !_isEmpty(userData.userGuid) && (realStatus === 1 || memberLevel > 0) && !broadcastNO &&
                  ...
                  <div style={{ "display": platformCurrent === 1 ? "block" : "none" }}>
                    {_isEmpty(userData) && <NoLogin id={id} ipTypeNumber={ipTypeNumber} history={history}/>}
                    {!_isEmpty(userData) && broadcastNO && memberLevel > 0 &&
                    <NoResult/>}
                    {!_isEmpty(userData) && !broadcastNO && memberLevel < 1 && realStatus !== 1 && <Certification/>}
                    {!_isEmpty(userData) && !_isEmpty(userData.userGuid) && (realStatus === 1 || memberLevel > 0) && !broadcastNO &&
                    !_isEmpty(broadcastTrendData) &&
                    <EchartDataZoomTwo container="echart-bar" data={toJS(broadcastTrendData)} date={broadcastTrendDate}
                                       subtext=""/>
                    }
                  </div>
                  <div style={{ "display": platformCurrent === 2 ? "block" : "none" }}>
                    {_isEmpty(userData) && <NoLogin id={id} ipTypeNumber={ipTypeNumber} history={history}/>}
                    {!_isEmpty(userData) && broadcastNO && (realStatus === 1 || memberLevel > 0) &&
                    <NoResult/>}
                    {!_isEmpty(userData) && realStatus !== 1 && memberLevel < 1 && !broadcastNO &&
                    <Certification/>}
                    {!_isEmpty(userData) && !_isEmpty(userData.userGuid) && realStatus === 1
                    && !broadcastNO && !_isEmpty(broadcastTrendData) &&
                    <EchartDataZoom container="echart-bar" data={broadcastTrendData} date={broadcastTrendDate}
                                    subtext=""/>
                    }
                  </div>
                </div>
            ...
            }
            {
              ...
              <div className="module-box">
                ...
                {
                  !_isEmpty(userData) && (realStatus === 1 || memberLevel > 0) &&
            ...
            }
            {
              ...
              <div className="module-box">
                ...
                <div className="area-content movie-content hot-content">
                  {_isEmpty(userData) && <NoLogin id={id} ipTypeNumber={ipTypeNumber} history={history}/>}
                  {!_isEmpty(userData) && memberLevel > 0 && _isEmpty(publicPraiseData) && <NoResult/>}
                  {!_isEmpty(userData) && memberLevel < 1 && realStatus !== 1 && <Certification/>}
                  {!_isEmpty(userData) && !_isEmpty(userData.userGuid) && memberLevel > 0 &&
            ...
            <div className="module-box">
              ...
              {_isEmpty(userData) &&
              <div className="area-content hot-content"><NoLogin id={id} ipTypeNumber={ipTypeNumber} history={history}/>
              </div>}
              {!_isEmpty(userData) && memberLevel < 1 && realStatus !== 1 &&
              <div className="area-content hot-content"><Certification/></div>}
            </div>
            <div className="module-box">
              <p className="area-title">
            ...
            <div className="module-box">
              ...
              {
                !_isEmpty(userData) && (memberLevel > 0 || realStatus === 1) &&
          ...
          <div className="tab-content" style={{ "display": isShow3 }}>
            <div className="module-box">
              ...
              <div className="area-content fans-content "><NoLogin id={id} ipTypeNumber={ipTypeNumber}
                                                                   history={history}/></div>}
              {!_isEmpty(userData) && _isEmpty(sexData) && _isEmpty(ageData) && memberLevel > 1 &&
              <div className="area-content fans-content "><NoResult/></div>}
              {!_isEmpty(userData) && memberLevel < 2 &&
              <div className="area-content fans-content "><Vip/></div>}
              {!_isEmpty(userData) && !_isEmpty(userData.userGuid) && memberLevel > 1 &&
            ...
            <div className="module-box">
              ...
              <div className="area-content city-content">
                ...
                {!_isEmpty(userData) && _isEmpty(ipProvinceData) && _isEmpty(yProvince) && memberLevel > 1 &&
            ...
            </div>
            {
              ...
              <div className="module-box">
                ...
                <div className="area-content city-content">
                  {_isEmpty(userData) && <NoLogin id={id} ipTypeNumber={ipTypeNumber} history={history}/>}
                  {!_isEmpty(userData) && _isEmpty(businessData) && memberLevel > 1 && <NoResult/>}
                  {!_isEmpty(userData) && memberLevel < 2 && <Vip/>}
                  {!_isEmpty(userData) && !_isEmpty(userData.userGuid) && memberLevel > 1
...

            {
              ...
              <div className="module-box flex-row">
                ...
                <div className="area-content tv-movie-content">
                  {
                    detail.isLoading && memberLevel > 1 &&
                  ...
                  {!_isEmpty(userData) && memberLevel < 2 && <Vip/>}
                  {
                    !_isEmpty(userData) && memberLevel > 1 && !_isEmpty(treeData) && !detail.isLoading &&
            ...
            <div className="module-box flex-row justify-content-between">
              ...
              <div className="area-content cloud-world-content">
                ...
                {_isEmpty(userData) && <NoLogin id={id} ipTypeNumber={ipTypeNumber} history={history}/>}
                {!_isEmpty(userData) && memberLevel < 2 && <Vip/>}
                {!_isEmpty(userData) && memberLevel > 1 && !_isEmpty(ipWordCloudData) && !detail.isLoading &&
